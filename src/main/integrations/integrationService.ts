...
function claudeRequiredEntriesForHome(
  ...
  return [
    ...
    { eventName: "PermissionRequest", matcher: "*", command },
    { eventName: "PostToolUse", matcher: "*", command },
    { eventName: "PostToolUseFailure", matcher: "*", command },

...
function taskFromSessionMeta(payload: Record<string, unknown>): string {
  ...
  return cwdBase ? `Codex Internal session: ${cwdBase}` : "Codex Internal session";
}
...
export function normalizeCodexInternalLogEvent(
  line: string,
  sourcePath: string,
  ...
  if (entryType === "session_meta") {
    ...
    switch (eventType) {
      case "user_message": {
        ...
        if (fullMessage) {
          activityItems = [
            {
              id: `codex-internal:${timestamp}:user-message`,
              kind: "message",
              source: "user",
              title: "User",
              body: fullMessage,
      ...
      case "task_started":
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:task-started`,
            kind: "note",
            source: "system",
            title: "Running",
            body: "Working",
      ...
      case "task_complete": {
        ...
        if (fullLastAgentMessage) {
          activityItems = [
            {
              id: `codex-internal:${timestamp}:task-complete`,
              kind: "message",
              source: "assistant",
              title: "Assistant",
      ...
      case "turn_aborted":
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:turn-aborted`,
            kind: "system",
            source: "system",
            title: "Turn aborted",
            body: "Turn aborted",
      ...
      case "context_compacted":
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:context-compacted`,
            kind: "system",
            source: "system",
      ...
      case "agent_message": {
        ...
        if (fullAgentMessage) {
          activityItems = [
            {
              id: `codex-internal:${timestamp}:final-answer`,
              kind: "message",
              source: "assistant",
              title: "Assistant",
    ...
    switch (itemType) {
      case "message": {
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:response-message`,
            kind: "message",
            source: "assistant",
            title: "Assistant",
            body: messageText,
      ...
      case "function_call": {
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:function-call:${toolName}`,
            kind: "tool",
            source: "tool",
            title: toolName,
            body: argumentsText,
      ...
      case "function_call_output": {
        ...
        activityItems = [
          {
            id: `codex-internal:${timestamp}:function-output:${toolName}`,
            kind: "tool",
            source: "tool",
            title: toolName,
            body: outputText,

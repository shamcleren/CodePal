...
CodePal stores local app data under the standard Electron app data directory for `codepal`, including settings, isolated auth session data for supported integrations, and updater-related state.

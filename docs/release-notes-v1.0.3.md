...
- Added a main-panel update status button for actionable update states.
...
- Release notes are kept as plain Markdown for the app update panel.
- The release workflow continues to validate macOS updater metadata and distributable assets.
- Use a v1.0.2 client to verify in-app update discovery and upgrade to v1.0.3.

...
- `docs/release-notes-v1.1.9.md`
  English release notes for the current v1.1.9 patch candidate. Keep this short enough for the in-app update panel.
- `docs/release-notes-v1.1.9.zh-CN.md`
  Chinese release notes for the current v1.1.9 patch candidate. Keep this short enough for the in-app update panel.

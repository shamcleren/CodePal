...
- **Local usage backfill**: Claude and Codex history can be imported into analytics, with readable top-session summaries based on the first user message instead of opaque IDs.
